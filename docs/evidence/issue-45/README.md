...
The two browser tests exercise axis identity/handedness, calibrated camera
...
landmark selection, native cursor/timeline synchronization, missing-region text,
orbit/pan/zoom, project context release and late-response rejection. Their API
